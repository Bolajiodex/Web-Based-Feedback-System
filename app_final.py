...
st.markdown("**Caleb University** | Powered by Streamlit")

# Create tabs for different sections
tab1, tab2, tab3 = st.tabs(["📝 Submit Feedback", "📊 Analytics Dashboard", "🔍 Data Insights"])
...
with tab3:
    ...
    if not themes_df.empty:
        ...
        subtab1, subtab2, subtab3 = st.tabs(["Top Themes", "Category Distribution", "Sentiment Analysis"])
